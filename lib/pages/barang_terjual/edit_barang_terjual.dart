...
class EditBarangTerjual extends StatefulWidget {
  const EditBarangTerjual({super.key});

  @override
  State<EditBarangTerjual> createState() => _EditBarangTerjualState();
}

class _EditBarangTerjualState extends State<EditBarangTerjual> {
  ...
  Future<void> _save() async {
    ...
    await TransaksiRepository().updateBarangTerjual(transaksi);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Edit Barang Terjual"),
        centerTitle: true,
        backgroundColor: const Color(0xFFC6EFE7),
        elevation: 0,
      ),
